...
def test_api_documents_trashbin_anonymous(reach, role):
    ...
    response = APIClient().get("/docs/api/v1/documents/trashbin/")
...
def test_api_documents_trashbin_format():
    ...
    response = client.get("/docs/api/v1/documents/trashbin/")
...
def test_api_documents_trashbin_pagination(
    ...
    assert content["next"] == "http://testserver/docs/api/v1/documents/trashbin/?page=2"
    ...
    # Get page 2
    response = client.get(
        "/docs/api/v1/documents/trashbin/?page=2",
    )
    ...
    assert content["previous"] == "http://testserver/docs/api/v1/documents/trashbin/"
...
def test_api_documents_trashbin_distinct():
    ...
    response = client.get(
        "/docs/api/v1/documents/trashbin/",
    )
