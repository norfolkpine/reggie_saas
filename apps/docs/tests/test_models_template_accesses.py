...
def test_models_template_access_get_abilities_for_owner_of_owner():
    ...
    user = factories.UserTemplateAccessFactory(template=access.template, role="owner").user
    abilities = access.get_abilities(user)
    assert abilities == {
        "destroy": True,
        "retrieve": True,
...
def test_models_template_access_get_abilities_for_administrator_of_owner():
    ...
    access = factories.UserTemplateAccessFactory(role="owner")
    factories.UserTemplateAccessFactory(template=access.template)  # another one
    user = factories.UserTemplateAccessFactory(template=access.template, role="administrator").user
    abilities = access.get_abilities(user)
    assert abilities == {
        "destroy": False,
        "retrieve": True,
...
def test_models_template_access_get_abilities_for_editor_of_owner():
    ...
    access = factories.UserTemplateAccessFactory(role="owner")
    factories.UserTemplateAccessFactory(template=access.template)  # another one
    user = factories.UserTemplateAccessFactory(template=access.template, role="editor").user
    abilities = access.get_abilities(user)
    assert abilities == {
        "destroy": False,
        "retrieve": True,
...
def test_models_template_access_get_abilities_for_reader_of_owner():
    ...
    access = factories.UserTemplateAccessFactory(role="owner")
    factories.UserTemplateAccessFactory(template=access.template)  # another one
    user = factories.UserTemplateAccessFactory(template=access.template, role="reader").user
    abilities = access.get_abilities(user)
    assert abilities == {
        "destroy": False,
        "retrieve": True,
