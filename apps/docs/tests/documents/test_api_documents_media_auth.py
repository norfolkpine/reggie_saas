...
def test_api_documents_media_auth_unkown_document():
    ...
    response = APIClient().get("/docs/api/v1/documents/media-auth/", HTTP_X_ORIGINAL_URL=original_url)
...
def test_api_documents_media_auth_anonymous_authenticated_or_restricted(reach):
    ...
    response = APIClient().get("/docs/api/v1/documents/media-auth/", HTTP_X_ORIGINAL_URL=media_url)
...
def test_api_documents_media_auth_authenticated_public_or_authenticated(reach):
    ...
    response = client.get("/docs/api/v1/documents/media-auth/", HTTP_X_ORIGINAL_URL=media_url)
