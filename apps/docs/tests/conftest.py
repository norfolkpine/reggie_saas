...
def pytest_configure():
    ...
    settings.DATABASES = {"default": test_settings}
...
def mock_storage():
    ...
    mock_head = {"Metadata": {}, "ContentType": "application/octet-stream", "ContentDisposition": "inline"}
    mock_client.head_object.return_value = mock_head

    # Mock list operations
    mock_versions = {"Versions": [{"Key": "test-key", "VersionId": "1"}]}
