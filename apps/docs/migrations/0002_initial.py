...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='document',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='accesses', to='docs.document'
            ),
        ),
        migrations.AddField(
            model_name='documentaccess',
        ...
        migrations.AddField(
            ...
            name='document',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='favorited_by_users', to='docs.document'
            ),
        ),
        migrations.AddField(
            model_name='documentfavorite',
        ...
        migrations.AddField(
            ...
            name='document',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='invitations', to='docs.document'
            ),
        ),
        migrations.AddField(
            model_name='invitation',
        ...
        migrations.AddField(
            ...
            name='document',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='link_traces', to='docs.document'
            ),
        ),
        migrations.AddField(
            model_name='linktrace',
            name='user',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='link_traces', to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            ...
            name='template',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='accesses', to='docs.template'
            ),
        ),
        migrations.AddField(
            model_name='templateaccess',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ('deleted_at__isnull', True), ('deleted_at', models.F('ancestors_deleted_at')), _connector='OR'
                ),
