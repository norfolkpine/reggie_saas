            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="teams", through="teams.Membership", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(
                        choices=[("admin", "Administrator"), ("member", "Member")], default="member", max_length=100
                    ),
                ),
                ...
                (
                    "team",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="invitations", to="teams.team"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "teams",
                    models.ManyToManyField(
                        blank=True, help_text="Activate this flag for these teams.", to="teams.team"
                    ),
                ),
            ],
            options={
