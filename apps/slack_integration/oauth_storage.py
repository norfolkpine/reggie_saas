...
class DjangoOAuthStateStore(OAuthStateStore):
    ...
    def issue(self, team_id: str = None) -> str:
        ...
        SlackOAuthState.objects.create(state=state, expire_at=expire_at, team_id=team_id)
    ...
    def consume(self, state: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            valid_states = SlackOAuthState.objects.filter(state=state, expire_at__gte=timezone.now())
