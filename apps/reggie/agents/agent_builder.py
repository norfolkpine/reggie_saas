...
class AgentBuilder:
    ...
    def build(self) -> Agent:
        ...
        knowledge_base = build_knowledge_base(django_agent=self.django_agent, user_uuid=self.user.uuid, knowledgebase_id=self.django_agent.knowledge_base.knowledgebase_id)
