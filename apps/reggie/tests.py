...
class FileAPIKeyAuthenticationTest(APITestCase):
    def setUp(self):
        ...
        self.system_api_key, self.system_key = APIKey.objects.create_key(
    ...
    def test_update_progress_with_system_api_key(self):
        ...
        headers = {
            'Authorization': f'Api-Key {self.system_key}'
        }
        data = {
            'progress': 50.0,
            'processed_docs': 5,
    ...
    def test_update_progress_with_user_api_key_fails(self):
        ...
        headers = {
            'Authorization': f'Api-Key {self.user_api_key[1]}'
        }
        data = {
            'progress': 50.0,
            'processed_docs': 5,
    ...
    def test_update_progress_with_invalid_api_key(self):
        ...
        headers = {
            'Authorization': 'Api-Key invalid-key'
        }
        data = {
            'progress': 50.0,
            'processed_docs': 5,
    ...
    def test_update_progress_with_wrong_prefix(self):
        ...
        headers = {
            'Authorization': f'Bearer {self.system_key}'
        }
        data = {
            'progress': 50.0,
            'processed_docs': 5,
