...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='uploaded_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ephemeral_files', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='file',
            name='collection',
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_kb_team_links', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='knowledgebasepermission',
            name='knowledge_base',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permission_links', to='reggie.knowledgebase'),
        ),
        migrations.AddField(
            model_name='knowledgebasepermission',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='knowledgebase_permission_links', to='teams.team'),
        ),
        migrations.AddField(
            model_name='knowledgebase',
            name='permissions',
        ...
        migrations.AddField(
            ...
            name='session',
            field=models.ForeignKey(help_text='Related chat session.', on_delete=django.db.models.deletion.CASCADE, related_name='feedbacks', to='reggie.chatsession'),
        ),
        migrations.AddField(
            model_name='userfeedback',
            name='user',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vault_files', to='reggie.project'),
        ),
        migrations.AddField(
            model_name='vaultfile',
            name='shared_with_teams',
        ...
        migrations.AddField(
            model_name='vaultfile',
            name='team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vault_files', to='teams.team'),
        ),
        migrations.AddField(
            model_name='vaultfile',
            name='uploaded_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vault_files', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='website',
            name='owner',
