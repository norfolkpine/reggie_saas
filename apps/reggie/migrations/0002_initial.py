...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="agent",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="parameters", to="reggie.agent"
            ),
        ),
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, related_name="ui_properties", to="reggie.agent"
            ),
        ),
        migrations.AddField(
            model_name="agent",
        ...
        migrations.AddField(
            ...
            name="agent",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="chat_sessions", to="reggie.agent"
            ),
        ),
        migrations.AddField(
            model_name="chatsession",
        ...
        migrations.AddField(
            ...
            name="file",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="knowledge_base_links", to="reggie.file"
            ),
        ),
        migrations.AddField(
            model_name="file",
        ...
        migrations.AddField(
            ...
            name="knowledge_base",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="file_links", to="reggie.knowledgebase"
            ),
        ),
        migrations.AddField(
            model_name="file",
            ...
            field=models.ManyToManyField(
                ...
                through="reggie.FileKnowledgeBaseLink",
                to="reggie.knowledgebase",
            ),
        ),
        migrations.AddField(
            model_name="agent",
            name="knowledge_base",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="reggie.knowledgebase"
            ),
        ),
        migrations.AddField(
            ...
            name="kb",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="pdf_urls", to="reggie.knowledgebase"
            ),
        ),
        migrations.AddField(
            model_name="knowledgebasepdfurl",
        ...
        migrations.AddField(
            ...
            name="knowledge_base",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="permission_links", to="reggie.knowledgebase"
            ),
        ),
        migrations.AddField(
            model_name="knowledgebasepermission",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                related_name="knowledge_bases",
                through="reggie.KnowledgeBasePermission",
                to="teams.team",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="tool",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="team_credentials", to="reggie.tool"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="tool",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="user_credentials", to="reggie.tool"
            ),
        ),
        migrations.AddField(
            model_name="usertoolcredential",
        ...
        migrations.AddField(
            ...
            name="tags",
            field=models.ManyToManyField(
                blank=True, help_text="Optional tags for organizing websites.", to="reggie.tag"
            ),
        ),
