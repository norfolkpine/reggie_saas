# Generated by Django 5.2.2 on 2025-08-06 03:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(help_text="Upload a file to the user's file library or vault. Supported types: pdf, docx, txt, csv, json", max_length=1024, upload_to=apps.reggie.models.choose_upload_path)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('collection', models.ForeignKey(blank=True, help_text='Collection this file belongs to.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='files', to='reggie.collection')),
