...
def test_rbac_filtered_retriever():
    ...
    try:
        ...
        retriever = RBACFilteredRetriever(base_retriever=base_retriever, user=user, filters={"user_uuid": "user123"})
...
def main():
    ...
    tests = [test_rbac_service_basic, test_rbac_filtered_retriever, test_metadata_filtering]
