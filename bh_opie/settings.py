...
class Base(Configuration):
    ...
    SPECTACULAR_SETTINGS = {
        ...
        "TAGS": [
            ...
            {"name": "Agent Templates", "description": "Global agent templates"},
            {"name": "Agent Instructions", "description": "Agent instruction management"},
            {"name": "Agent Expected Output", "description": "Agent output templates"},
            {"name": "Storage Buckets", "description": "Storage bucket operations"},
            {"name": "Knowledge Bases", "description": "Knowledge base operations"},
            {"name": "Tags", "description": "Content tags"},
            {"name": "Projects", "description": "Project management"},
            {"name": "Files", "description": "File management"},
            {"name": "File Tags", "description": "File tag management"},
            {"name": "Global Instruction Templates", "description": "Global instruction templates"},
            ...
            {"name": "User Feedback", "description": "User feedback on chat sessions"},
            {"name": "Categories", "description": "Agent categories"},
            {"name": "Chat Sessions", "description": "Chat session management"},
            {"name": "Opie AI", "description": "Opie AI streaming operations"},
        ],
        "PREPROCESSING_HOOKS": ["apps.api.schema.filter_schema_apis"],
        "POSTPROCESSING_HOOKS": ["apps.api.schema.add_tag_groups"],
    }
