...
ROOT_URLCONF = "bh_timesheets.urls"
...
WSGI_APPLICATION = "bh_timesheets.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="bh_timesheets"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "bh_timesheets_language"
LANGUAGES = [
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="bh_timesheets-media")
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "BH Timesheet software",  # noqa: E501
    "VERSION": "0.1.0",
...
ASGI_APPLICATION = "bh_timesheets.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
PROJECT_METADATA = {
    ...
    "DESCRIPTION": gettext_lazy("BH Timesheet software"),  # noqa: E501
...
LOGGING = {
    ...
    "loggers": {
        ...
        "bh_timesheets": {
            "handlers": ["console"],
            "level": env("BH_TIMESHEETS_LOG_LEVEL", default="INFO"),
        },
    },
}
